...
export const saveRemoteAppState = async (state: AppState): Promise<SaveStatus> => {
  ...
  // Strip auto-generated recurring projections before saving.
  // They will be regenerated locally on load by applyRecurringProjection.
  const cleanState: AppState = {
    ...state,
    transactions: state.transactions.filter((tx) => !tx.autoGenerated),
  };
